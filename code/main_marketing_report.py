...
most_revenue_item = find_top_entry(item_summary, field="revenue")
most_units_item = find_top_entry(item_summary, field="units_sold")
...
print()
print(f'Top seller by revenue: {most_revenue_item["item"]} (${most_revenue_item["revenue"]:,.2f})')
print(f'Top seller by units:   {most_units_item["item"]} ({most_units_item["units_sold"]} units)')